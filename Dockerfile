...
# Configurar PowerShell con manejo de errores estricto
SHELL ["powershell", "-Command", "$ErrorActionPreference = 'Stop'; $ProgressPreference = 'SilentlyContinue';"]

# 1. INSTALAR PYTHON 3.11 (Ruta Absoluta)
...
# 2. INSTALAR VC REDIST (Fix crítico para Torch/WinError 126)
...
# 4. INSTALAR OPENSSH (FIX ERROR 0x2 - Separación de capas para asentamiento de archivos)
ADD https://github.com/PowerShell/Win32-OpenSSH/releases/download/v9.5.0.0p1-Beta/OpenSSH-Win64.zip C:/openssh.zip

# Extraer y asentar carpeta (Paso Atómico)
...
# Instalar servicio (Paso Atómico con ruta absoluta)
...
# 5. INSTALAR DEPENDENCIAS (Uso de ruta absoluta para Pip)
